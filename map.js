...
function fen_requete(){
    ...
    $("#bouton_lancer_rqt").css({display: "inline-block",left:"82%",top:"5%"});
    };
...
$(function() {
    ...
    $(document).ready(function(){
              ...
              console.log("critere 2 en selectionné");
              var crit2 = 0;
          });
...
$(function () {
    $("#attributes" ).change(function () {
        ...
        if (value_type == 'xsd:short' || value_type == 'xsd:int' || value_type == 'xsd:double'){
            ...
            operator1.options[3] = new Option('Egal ', '=');
        }
        else if (value_type == 'xsd:string')
        {
            var operator1 = document.getElementById("operator");
            operator1.options[1] = new Option('Est', 'ILike');
        }
    });
});
...
$(function () {
    $("#attributes2" ).change(function () {
        ...
        if (value_type2 == 'xsd:short' || value_type2 == 'xsd:int' || value_type2 == 'xsd:double'){
            var operator2 = document.getElementById("operator2");
            operator2.options[1] = new Option('Supérieur à', '>');
            operator2.options[2] = new Option('Inférieur à', '<');
            operator2.options[3] = new Option('Egal à', '=');
        }
        else if (value_type2 == 'xsd:string'){
            var operator2 = document.getElementById("operator2");
            operator2.options[1] = new Option('Est', 'ILike');
        }
...
$(function () {
    $("#attributes3" ).change(function () {
        ...
        if (value_type3 == 'xsd:short' || value_type3 == 'xsd:int' || value_type3 == 'xsd:double')
        {
            var operator3 = document.getElementById("operator3");
            operator3.options[1] = new Option('Supérieur à', '>');
            operator3.options[2] = new Option('Inférieur à', '<');
            operator3.options[3] = new Option('Egal à', '=');
        }
        else if (value_type3 == 'xsd:string')
        {
            var operator3 = document.getElementById("operator3");
            operator3.options[1] = new Option('Est', 'ILike');
        }
    });
});
...
$(function () {
    $("#attributes4").change(function () {
        ...
        if (value_type4 == 'xsd:short' || value_type4 == 'xsd:int' || value_type4 == 'xsd:double')
        {
            var operator4 = document.getElementById("operator4");
            operator4.options[1] = new Option('Supérieur à', '>');
            operator4.options[2] = new Option('Inférieur à', '<');
            operator4.options[3] = new Option('Egal à', '=');
        }
        else if (value_type4 == 'xsd:string')
        {
            var operator4 = document.getElementById("operator4");
            operator4.options[1] = new Option('Est', 'ILike');
        }
    });
});
...
$(function () {
    $("#attributes5" ).change(function () {
        ...
        if (value_type5 == 'xsd:short' || value_type5 == 'xsd:int' || value_type5 == 'xsd:double')
        {
            var operator5 = document.getElementById("operator5");
            operator5.options[1] = new Option('Supérieur à', '>');
            operator5.options[2] = new Option('Inférieur à', '<');
            operator5.options[3] = new Option('Egal à', '=');
        }
        else if (value_type5 == 'xsd:string')
        {
            var operator5 = document.getElementById("operator5");
            operator5.options[1] = new Option('Est', 'ILike');
        }
    });
});
...
function query() {
    ...
    //Cases à cocher
    var critereCoche1 = document.getElementById("crt1").checked;
    var critereCoche2 = document.getElementById("crt2").checked;
    var critereCoche3 = document.getElementById("crt3").checked;
    var critereCoche4 = document.getElementById("crt4").checked;
    var critereCoche5 = document.getElementById("crt5").checked;

    //Variaton des opérateurs
    ...
    if (value_operator2 == 'ILike')
    {
        value_txt2 = ""+value_txt2+"%25";
    }
    else{
        value_txt2 = value_txt2;
    }
    if (value_operator3 == 'ILike')
    {
        value_txt3 = ""+value_txt3+"%25";
    }
    else{
        value_txt3 = value_txt3;
    }
    if (value_operator4 == 'ILike')
    {
        value_txt4 = ""+value_txt4+"%25";
    }
    else{
        value_txt4 = value_txt4;
    }
    if (value_operator5 == 'ILike')
    {
        value_txt5 = ""+value_txt5+"%25";
    }
    else{
    ...
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(xml) {
                ...
                // console.log("here");
                $('<tr></tr>').html('<th>Centre</th><th>Nom</th><th>Observations</th>').appendTo('#table_wms_layers');
